...
namespace Testing5
{
    ...
    public class tstSupplier
    {
        ...
        public void TestPostcodeOK()
        {
            ...
            if (AnSupplier.Postcode != "le5 6gh")
            {
                OK = false;
            }
            //test to see if the result is correct
        ...
        public void TestAddressOK()
        {
            ...
            if (AnSupplier.Address != "dsfsfgfdg")
            {
                OK = false;
            }
            //test to see if the result is correct
        ...
        public void TestContactPhoneOK()
        {
            ...
            if (AnSupplier.ContactPhone != "034938391")
            {
                OK = false;
            }
            //test to see if the result is correct
        ...
        public void TestEmailOK()
        {
            ...
            if (AnSupplier.Email != "sahdjsa@gmail")
            {
                OK = false;
            }
            //test to see if the result is correct
        ...
        public void TestCompanyNameOK()
        {
            ...
            if (AnSupplier.CompanyName != "meryem")
            {
                OK = false;
            }
            //test to see if the result is correct
